...
**Versão do inventário:** 3.6 — WP-031A→H certificados
...
- **WP-031 Fiscal** está em execução sequencial na PR #118: WP-031A→H estão implementados/certificados. O WP-031H estendeu a autoridade financeira canônica com obrigação de compra, ajustes, reconciliação e decisão tributária explícita no HEAD funcional `1cd054e4d0748faafeb781cb145d0f4824be2bad`, gate run `35512559855` SUCCESS. O WP-031 permanece PENDING e o WP-031I não foi iniciado.
...
1. **WP-031 — Fiscal:** baseline V1 localizado, congelado e vendorizado. WP-031A→H estão implementados/certificados; o WP-031H foi certificado no gate `WP-031H Financial Tax Bridge` run `35512559855`, com 24/24 workflows SUCCESS no HEAD funcional. WP-031I→L e o Master Gate permanecem pendentes.
