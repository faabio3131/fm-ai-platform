...
**Versão do inventário:** 3.6 — WP-031A→I certificados
...
- **WP-031 Fiscal** está em execução sequencial na PR #118: WP-031A→I estão implementados/certificados. O WP-031H estendeu a autoridade financeira canônica com obrigação de compra, ajustes, reconciliação e decisão tributária explícita no HEAD funcional `1cd054e4d0748faafeb781cb145d0f4824be2bad`, gate run `35512559855` SUCCESS. O WP-031 permanece PENDING e o WP-031I não foi iniciado.
...
| WP-031 | Fiscal / NFC-e / SAT | Fiscal V1 congelado `b336def47ad4f5188307102203f4e04b98406014` vendorizado; WP-031A→I implementados/certificados | Persistência, outbound, perfis, inbound, intake, procurement e bridge financeiro/tributário integrados; provider/SEFAZ real e blocos I→L não executados | — | PARCIAL — A→H CERTIFIED / I PENDING | Preservar separação entre documento, recebimento, obrigação, pagamento e crédito; WP-031I permanece PENDING / NÃO INICIADO. |
...
1. **WP-031 — Fiscal:** baseline V1 localizado, congelado e vendorizado. WP-031A→I estão implementados/certificados; o WP-031H foi certificado no gate `WP-031H Financial Tax Bridge` run `35512559855`, com 24/24 workflows SUCCESS no HEAD funcional. WP-031I→L e o Master Gate permanecem pendentes.
...
6. **WP-031 → continuar sequência fiscal congelada**: A→H concluídos/certificados; WP-031I→L, Master Gate e só então Visual Premium permanecem pendentes.
