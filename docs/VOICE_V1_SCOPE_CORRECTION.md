...
## 8. Preservação durante a faxina canônica

Este documento foi recuperado de uma linha antiga de estabilização e recolocado na linha canônica em 04/09/2026 para impedir que a exigência VOICE-V1 se perdesse ao encerrar PRs superseded.