...
def aplicar(texto: str) -> str:
    if (
        ...
        and "components.html(preparacao.html" in texto
    ):
        return texto
...
def main() -> None:
    ...
    if atualizado == original:
        print("UI ja contem o healthcheck browser do Google Maps; nenhuma alteracao necessaria.")
        return
    TARGET.write_text(atualizado, encoding="utf-8")
    print("UI atualizada com prova real da Maps JavaScript API no navegador.")
