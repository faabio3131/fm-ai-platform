...
**Versão do inventário:** 3.5 — WP-031A→G certificados
...
- **WP-031 Fiscal** está em execução sequencial na PR #118: WP-031A→G estão implementados/certificados. O WP-031G fechou a autoridade única de procurement, recebimento físico conciliado ao XML/DF-e, estoque transacional e custo histórico no HEAD funcional `040d26154d3eb344e7b81b070ad619d22ff42357`, gate run `35510517704` SUCCESS. O WP-031 permanece PENDING e o WP-031H não foi iniciado.
...
| WP-031 | Fiscal / NFC-e / SAT | Fiscal V1 congelado `b336def47ad4f5188307102203f4e04b98406014` vendorizado; WP-031A→G implementados/certificados | Persistência, outbound, perfis, inbound, intake inteligente e procurement integrados; provider/SEFAZ real e blocos H→L não executados | — | PARCIAL — A→G CERTIFIED / H PENDING | Preservar XML/DF-e + confirmação física como autoridade de entrada e o ledger de estoque canônico; WP-031H permanece PENDING / NÃO INICIADO. |
...
1. **WP-031 — Fiscal:** baseline V1 localizado, congelado e vendorizado. WP-031A→G estão implementados/certificados; o WP-031G foi certificado no gate `WP-031G Procurement Integration` run `35510517704`, com 23/23 workflows SUCCESS no HEAD funcional. WP-031H→L e o Master Gate permanecem pendentes.
...
6. **WP-031 → continuar sequência fiscal congelada**: A→G concluídos/certificados; WP-031H→L, Master Gate e só então Visual Premium permanecem pendentes.
